...
d. Interprete o valor do coeficiente de determinação $R^2$.

e. Teste os pressupostos do modelo e responda: a regressão linear foi um modelo apropriado?

2. Importe o arquivo `Pressao_pulso.csv`. Faça um gráfico de dispersão entre pressão diastólica e idade. Utilize um modelo de regressão linear para testar a hipótese de que a taxa de pulsação varia em função da idade. Responda:
